...
insert into studios (id, name, blurb, note, address, sea) values
  ('central', 'Central',      'Refined energy in the heart of the city', null,                            '1701, 17/F, H Queen’s, 80 Queen’s Road Central', false),
  ('cwb',     'Causeway Bay', 'Vibrant and social — always in motion',   null,                            '20/F, The Hedon, 11 Matheson Street, Causeway Bay', false),
  ('qb',      'Quarry Bay',   'Sea-view stillness above the harbour',    null,                            '1906, 19/F, Westlands Centre, 20 Westlands Road, Quarry Bay', true),
  ('kt',      'Kwun Tong',    'Industrial calm, athletic focus',         null,                            '30B, TG Place, 10 Shing Yip Street, Kwun Tong', false),
  ('lck',     'Lai Chi Kok',  'Quiet, local and grounded',               null,                            'B, 31/F, Billion Plaza II, 10 Cheung Yue Street, Lai Chi Kok', false)
