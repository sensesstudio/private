...
// ph: tonal placeholder class (blush default / sage / taupe / almond)
const TEACHERS = [
  {
...
// real-time status + match reasoning (augment in place)
...
// Packages / pricing (HKD)
const PACKAGES = [
  { id: 'trial',  name: 'First session', credits: 1,  price: 900, per: 900, tag: 'Begin', blurb: 'A single private to find your fit.' },
  { id: 'starter',name: '5-class pack',  credits: 5,  price: 4750, per: 950, tag: '', blurb: 'Five privates · valid 3 months.' },
  { id: 'studio', name: '10-class pack', credits: 10, price: 9000, per: 900, tag: 'Most chosen', blurb: 'Ten privates · best value · valid 6 months.', popular: true },
];
...
const INJURIES = ['Lower back', 'Knees', 'Shoulders', 'Neck', 'Wrists', 'Hips', 'None'];
const SCHEDULES = [
...
// Clients (for admin / teacher views)
const CLIENTS = [
...
// Earnings series (teacher dashboard) — last 6 months HKD
const EARNINGS = [
  { m: 'Jan', v: 38200 }, { m: 'Feb', v: 41600 }, { m: 'Mar', v: 47900 },
  { m: 'Apr', v: 44300 }, { m: 'May', v: 52100 }, { m: 'Jun', v: 49400 },
];
// Studio revenue series (admin) — HKD thousands
const REVENUE = [
  { m: 'Jan', v: 612 }, { m: 'Feb', v: 648 }, { m: 'Mar', v: 731 },
  { m: 'Apr', v: 705 }, { m: 'May', v: 812 }, { m: 'Jun', v: 768 },
];

// Progress log — Mara's last sessions (newest first). Each = one completed class.
const PROGRESS_LOG = [
...
Object.assign(window, {
  LOCATIONS, TEACHERS, teacherById, locName, PACKAGES,
  GOALS, INJURIES, SCHEDULES, LEVELS, CLIENTS, BOOKINGS, APPLICANTS, EARNINGS, REVENUE, PROGRESS_LOG,
});
