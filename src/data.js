...
const DEMO_LOCATIONS = [
  { id: 'central', name: 'Central',      blurb: 'Refined energy in the heart of the city', note: '', address_zh: '中環皇后大道中80號H Queen’s 17樓', address: '1701, 17/F, H Queen’s, 80 Queen’s Road Central' },
  { id: 'cwb',     name: 'Causeway Bay', blurb: 'Vibrant and social — always in motion',   note: '', address_zh: '銅鑼灣勿地臣街 11 號 The Hedon 20 樓', address: '20/F, The Hedon, 11 Matheson Street, Causeway Bay' },
  { id: 'qb',      name: 'Quarry Bay',   blurb: 'Sea-view stillness above the harbour',    note: '', sea: true, address: '1906, 19/F, Westlands Centre, 20 Westlands Road, Quarry Bay' },
  { id: 'kt',      name: 'Kwun Tong',    blurb: 'Industrial calm, athletic focus',         note: '', address_zh: '觀塘成業街 10 號電訊一代廣場 (TG Place) 30 樓 B 室', address: '30B, TG Place, 10 Shing Yip Street, Kwun Tong' },
  { id: 'lck',     name: 'Lai Chi Kok',  blurb: 'Quiet, local and grounded',               note: '', address: 'B, 31/F, Billion Plaza II, 10 Cheung Yue Street, Lai Chi Kok' },
];
...
const DEMO_TEACHERS = [
  {
    ...
    rate: 950, locId: 'central', locIds: ['central', 'cwb'], exp: 9, rating: 4.9, reviews: 212, match: 96,
    langs: ['English', 'Cantonese'],
    certs: ['STOTT Reformer (Full)', 'Polestar Rehabilitation', 'Pre/Postnatal'],
    bio: 'Hailey blends clinical precision with calm. After nine years and a background in physiotherapy, she specialises in returning the body to ease — rebuilding strength around old injuries, one breath at a time.',
  ...
  },
  {
    ...
    rate: 950, locId: 'cwb', exp: 6, rating: 4.8, reviews: 148, match: 91,
    langs: ['English', 'Mandarin'],
    certs: ['BASI Comprehensive', 'TRX Suspension'],
    bio: 'Minna trains the body like an athlete and treats the mind like a teammate. Expect dynamic, sweat-earning sessions that still end in stillness.',
  ...
  },
  {
    ...
    bio: 'Evanne holds space for the body in transition — pregnancy, recovery, rest. Her sessions are gentle, intelligent and quietly strengthening.',
  ...
  },
  {
    ...
    rate: 950, locId: 'kt', exp: 5, rating: 4.7, reviews: 94, match: 84,
    langs: ['English', 'Japanese'],
    certs: ['Balanced Body Mat', 'FRC Mobility'],
    bio: 'Vesta makes mobility feel like play. Her mat and conditioning work builds resilient, capable bodies that move well far beyond the studio.',
  ...
  },
  {
    ...
    rate: 950, locId: 'lck', exp: 4, rating: 4.8, reviews: 67, match: 79,
    langs: ['English', 'Cantonese'],
    certs: ['STOTT Matwork', 'Anatomy in Motion'],
    bio: 'Stacey is where many begin. Patient and exacting about the basics, she builds the foundation that makes every later practice safer and stronger.',
...
DEMO_TEACHERS.forEach(t => {
  ...
  t.photo = t.photo || `assets/teachers/${t.id}.webp`; // portrait; falls back to initials if absent
...
export const PACKAGES = LIVE_AVAILABILITY ? [] : [
  ...
  { id: 'p12-5',      format: '1:2', name: '5-class pack',  credits: 5,  price: 6500,  per: 1300,   validityMonths: 3, tag: '',            blurb: 'Five semi-private sessions.' },
  { id: 'p12-10',     format: '1:2', name: '10-class pack', credits: 10, price: 12000, per: 1200,   validityMonths: 6, tag: 'Most chosen', blurb: 'Ten semi-private sessions · best value.', popular: true },
];
...
export const PROGRESS_LOG = LIVE_AVAILABILITY ? [] : [
  ...
  { id: 'pl07', n: 7,  date: '2026-05-21', tId: 't2', focus: 'Core endurance & breathing',           note: 'Strong core engagement throughout. Watch the lower-back arch under fatigue — cue the deep breath to reset.', posture: 'Ribcage flares under fatigue; cueing helps re-stack over the pelvis.' },
  { id: 'pl06', n: 6,  date: '2026-05-14', tId: 't1', focus: 'Lower-back rehab — flexion control',   note: 'Pain-free full range today, a real milestone. Confidence is up. We can begin gentle loading from here.', posture: 'Full lumbar flexion pain-free; weight even through both feet.' },
  { id: 'pl05', n: 5,  date: '2026-05-07', tId: 't1', focus: 'Pelvic floor & deep core',             note: 'Good connection to the deep core. Practise the cat-cow at home to keep the spine mobile between sessions.', posture: 'Neutral pelvis held in quadruped; good deep-core connection.' },
  { id: 'pl04', n: 4,  date: '2026-04-30', tId: 't1', focus: 'Posture — thoracic extension',         note: 'Upper-back opened up nicely. Desk posture is the homework — set a reminder to reset every hour.', posture: 'Thoracic extension improved; forward-head posture still present at rest.' },
  { id: 'pl03', n: 3,  date: '2026-04-23', tId: 't1', focus: 'Foundations — neutral spine',          note: 'Finding neutral much faster now. Still cueing the shoulder drop; it\'ll become automatic with reps.', posture: 'Neutral spine found faster; left shoulder sits higher than right.' },
  { id: 'pl02', n: 2,  date: '2026-04-16', tId: 't1', focus: 'Breath & gentle mobilisation',         note: 'Settled in well. Breathing pattern improving. We kept load light to protect the lower back — right call.', posture: 'Breathing more diaphragmatic; guards the lower back when loaded.' },
  { id: 'pl01', n: 1,  date: '2026-04-09', tId: 't1', focus: 'Assessment & introduction',            note: 'Lovely first session. Mapped your lower-back history and set a gentle, progressive plan. Welcome to the studio.', posture: 'Baseline: anterior pelvic tilt, rounded upper back, tight hip flexors.' },
];
