...
import { DocumentSections, profileInstant } from '../live/ClientProfileForms.jsx';
...
export function ClientSubmittedDetails({client}) {
  ...
  return <div className="profile-stack" style={{marginTop:22}}>
    ...
    <Card pad={22}><h3>About me</h3>{!p?.intake_completed_at && <p className="admin-muted">No completed intake submission is recorded. Any existing answers are shown below.</p>}<dl className="admin-client-fields">
