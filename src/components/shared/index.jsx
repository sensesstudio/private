...
export function PhoneFrame({ children, navBar, overlay, showWhatsApp = true }) {
  return (
...
// Favourite teachers — shared across Home (boosts suggestions), teacher detail
// (heart), and Profile (favourites list).
const _favs = { ids: [] };

export function toggleFav(id) {
  _favs.ids = _favs.ids.includes(id) ? _favs.ids.filter(x => x !== id) : [..._favs.ids, id];
